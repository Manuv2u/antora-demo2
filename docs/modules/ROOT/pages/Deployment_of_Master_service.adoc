...
image::docs/modules/ROOT/pages/images/dockerfile.png[title=dockerfile,align="center",width=500]
...
image::docs/modules/ROOT/pages/images/gitlab cred.png[title=gitlab variables,align="center",width=500]
